...
const errorMessages: Record<string, string> = {
  missing_config: 'GitHub OAuth 환경 변수가 아직 설정되지 않았습니다.',
  invalid_state: '로그인 요청을 확인하지 못했습니다. 다시 시도해주세요.',
  token_failed: 'GitHub 인증 토큰을 가져오지 못했습니다.',
  profile_failed: 'GitHub 프로필을 가져오지 못했습니다.',
  oauth_failed: 'GitHub 로그인 중 문제가 발생했습니다.',
};
    ...
    <main className="flex min-h-screen items-center justify-center bg-slate-950 px-4 text-white">
      <section className="w-full max-w-md rounded-lg border border-slate-800 bg-slate-900/90 p-8 shadow-2xl">
        ...
        <p className="mt-3 text-sm leading-6 text-slate-400">
          GitHub 계정으로 로그인한 뒤 집중도 모니터링, 화상 집중방, 대시보드를 사용할 수 있습니다.
        </p>
        ...
        <p className="mt-5 text-xs leading-5 text-slate-500">
          개발 환경에서는 GitHub OAuth App의 callback URL을
          {' '}
